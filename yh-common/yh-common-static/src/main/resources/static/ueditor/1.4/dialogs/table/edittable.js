...
(function () {
    var title = $G("J_title"),
        ...
        customTableWidth = $G("J_customTableWidth"), // Winhai 2017-11-14 新增自定义表格宽度
        tone = $G("J_tone"),
        me,
        preview = $G("J_preview");
    ...
    editTable.prototype = {
        init:function () {
            ...
            domUtils.on(customTableWidth, "click", me.customTableWidthHanler); // Winhai 2017-11-14 新增自定义表格宽度
        ...
        // Winhai 2017-11-14 新增自定义表格宽度
        customTableWidthHanler:function () {
        	me.autoSizePageHanler();
        	domUtils.on($G("J_customTableWidthInput"), "keydown", function(){
                var example = $G("J_example");
                var input = $G("J_customTableWidthInput");
        		example.setAttribute('width', input.value);
        	});
        },
    ...
    dialog.onok = function () {
        ...
        customTableWidth.checked ? editor.execCommand("adaptbycustom",
        		$G("J_customTableWidthInput").value) : ""; // Winhai 2017-11-14 新增自定义表格宽度
