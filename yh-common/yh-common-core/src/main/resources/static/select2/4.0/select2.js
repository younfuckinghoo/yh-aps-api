...
//	  Winhai 禁用 First Item 高亮

	// Winhai 当超过设置最大选择长度时，自动关闭下拉框
...
S2.define('select2/i18n/zh_CN',[],function () {
  ...
  return {
    ...
    maximumSelected: function (args) {
      ...
      //if (args.maximum != 1) { // Winhai 删除多余的复数
      //  message += 's';
      //}
...
S2.define('select2/defaults',[
  ...
  Defaults.prototype.reset = function () {
    ...
    this.defaults = {
      ...
      theme: 'default',
      width: '100%' // Winhai 宽度自适应     'resolve'
    };
  };
...
S2.define('select2/core',[
  ...
  Select2.prototype._registerEvents = function () {
    ...
    this.on('close', function () {
      ...
      self.$selection.focus();  // Winhai 修正选择后焦点丢失
    });
    ...
    this.on('keypress', function (evt) {
      ...
      if (self.isOpen()) {
        ...
        if (/*key === KEYS.ENTER || */key === KEYS.SPACE || // Winhai 去掉回车后打开下拉框，解决jqgrid回车获取下一个输入框按键冲突
